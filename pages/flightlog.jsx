...
function FlightLogPage({ videoId, onNav }) {
  const v = window.VIDEOS.find(x => x.id === videoId) || window.VIDEOS[0];
  const loc = window.LOCATIONS.find(l => l.id === v.locationId) || window.LOCATIONS[0];
...
Object.assign(window, { FlightLogPage });
