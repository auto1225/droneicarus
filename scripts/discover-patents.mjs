...
const PATENT_QUERIES = [
  ...
  // ─── extension batch ───
  ['drone return to home',           ['safety','autonomous']],
  ['UAV waypoint navigation',        ['navigation','autonomous']],
  ['drone autopilot system',         ['firmware','autonomous']],
  ['drone IMU sensor fusion',        ['sensors','navigation']],
  ['UAV magnetometer compass',       ['sensors']],
  ['drone barometer altimeter',      ['sensors']],
  ['drone vibration damping',        ['hardware','mechanics']],
  ['UAV foldable arms',              ['hardware','mechanics']],
  ['drone quick release propeller',  ['propeller','hardware']],
  ['multi camera drone',             ['imaging']],
  ['drone night vision',             ['imaging','thermal']],
  ['drone optical zoom',             ['imaging']],
  ['UAV image stabilization',        ['imaging','gimbal']],
  ['drone payload winch',            ['delivery','manipulation']],
  ['drone parcel container',         ['delivery']],
  ['drone landing pad charging',     ['power','infrastructure']],
  ['UAV docking station',            ['power','infrastructure']],
  ['drone wireless charging',        ['power']],
  ['drone solar panel wing',         ['power','solar']],
  ['UAV emergency descent',          ['safety']],
  ['drone fly away prevention',      ['safety','firmware']],
  ['anti-drone radar',               ['counter-drone']],
  ['anti-drone net launcher',        ['counter-drone']],
  ['drone jamming detection',        ['counter-drone','radio']],
  ['drone forensics',                ['security','application']],
  ['UAV public safety',              ['emergency','application']],
  ['drone wildfire detection',       ['emergency','imaging']],
  ['drone power line inspection',    ['inspection','application']],
  ['drone wind turbine inspection',  ['inspection','application']],
  ['drone bridge inspection',        ['inspection','application']],
  ['drone roof inspection',          ['inspection','application']],
  ['drone cell tower inspection',    ['inspection','application']],
  ['UAV crop monitoring',            ['agriculture','imaging']],
  ['drone weed detection',           ['agriculture','ai']],
  ['drone livestock monitoring',     ['agriculture','imaging']],
  ['drone aquaculture monitoring',   ['agriculture']],
  ['UAV pollination',                ['agriculture','novel']],
  ['drone seed planting',            ['agriculture']],
  ['drone film cinematography',      ['imaging','application']],
  ['drone formation flying',         ['swarm','autonomous']],
  ['drone show LED',                 ['swarm','novel']],
  ['drone-based 3D scan',            ['mapping']],
  ['UAV photogrammetry',             ['mapping','imaging']],
  ['drone bathymetry survey',        ['mapping','underwater']],
  ['drone autonomous landing',       ['autonomous','safety']],
  ['drone visual odometry',          ['slam','autonomous']],
  ['drone obstacle detection ToF',   ['obstacle-avoidance','sensors']],
];
